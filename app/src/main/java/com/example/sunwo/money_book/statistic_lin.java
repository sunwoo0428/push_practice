...
public class statistic_lin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnSelectDateLin = (Button) findViewById(R.id.btn_selectDateLin);
        btnSelectDateLin.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                DialogSelectOptionLinDate();
            }
        });
    }

    private void DialogSelectOptionLinDate() {
