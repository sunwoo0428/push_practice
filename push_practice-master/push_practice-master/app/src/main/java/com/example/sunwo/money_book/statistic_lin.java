...
public class statistic_lin extends AppCompatActivity {
    ...
    private View mChart;
    private String[] mMonth = new String[7];
    private int[] expense = new int[7];
    String CurrentDate = "";
    ...
    protected void onResume() {
        ...
        for(int i=0;i<7;i++){
            expense[i]=dbExpense.GetTotalExpense(dbExpense.days7db[i]);
        }
    ...
    private void openChart(){
        ...
        expenseRenderer.setColor(getResources().getColor(R.color.skyblue)); //color of the graph set to cyan
        ...
        multiRenderer.setYTitle("Amount in Won");
        ...
        //setting text style
        multiRenderer.setTextTypeface("sans_serif", Typeface.ITALIC);
        ...
        multiRenderer.setMargins(new int[]{50, 150, 50, 50});
        ...
        //drawing bar chart
        mChart = ChartFactory.getBarChartView(statistic_lin.this, dataset, multiRenderer, BarChart.Type.STACKED);
